...
Una clase de tipo la definimos como un conjunto de operaciones que ciertos tipos pueden implementar. En el caso de Num, se define operaciones numéricas como suma, resta y multiplicación.
